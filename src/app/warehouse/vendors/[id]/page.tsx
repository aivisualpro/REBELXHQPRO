...
export default function VendorDetailPage() {
    ...
    }, [params.id, fetchVendor, fetchPurchaseOrders]);
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold">Carrier Pref.</span>
                                    </div>
                                    <span className="text-xs font-medium text-foreground">{vendor.carrierPreference || '-'}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            onClick={() => {
                                setEditForm({
                                    ...
                                    carrierPreference: vendor.carrierPreference || '',
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className="bg-background border border-border rounded shadow-2xl w-full max-w-2xl animate-in fade-in zoom-in duration-200">
                        <div className="flex items-center justify-between px-6 h-[36px] border-b border-border bg-secondary/50">
                            <h2 className="text-sm font-black uppercase text-foreground tracking-widest">Edit Vendor</h2>
                        ...
                        <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[11px] font-black text-muted-foreground uppercase tracking-wider">Carrier Pref.</label>
                                    <input
                                        type="text"
                                        value={editForm.carrierPreference || ''}
                                        onChange={e => setEditForm({ ...editForm, carrierPreference: e.target.value })}
                                        className="w-full px-3 h-[36px] border border-border rounded text-sm bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-primary/10"
                                    />
                                </div>
                                <div className="space-y-1.5">
                            ...
                            <div className="pt-2 flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-2.5 bg-primary text-primary-foreground text-xs font-bold uppercase rounded hover:opacity-90 transition-colors cursor-pointer"
                                >
                                    Save Changes
                                </button>
                            </div>
