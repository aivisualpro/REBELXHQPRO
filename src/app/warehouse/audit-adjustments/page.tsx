                    ...
                    <tbody className="divide-y divide-slate-100">
                        {loading ? (
                            ...
                            <tr key={item._id} className="hover:bg-slate-50 transition-colors">
                                ...
                                <td className="px-4 py-2 text-[11px] text-slate-600 font-mono">{item.lotNumber}</td>
                                <td className={cn(
                                ...
                                <td className="px-4 py-2 text-[11px] text-slate-600 max-w-xs truncate" title={item.reason}>{item.reason}</td>
                                <td className="px-4 py-2 text-[11px] text-slate-500">{renderUser(item.createdBy)}</td>
