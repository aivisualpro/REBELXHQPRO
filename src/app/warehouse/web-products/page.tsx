...
function WebsiteBadge({ website, platform }: { website?: string; platform?: string }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {platform === 'shopify' ? (
        <img src="/shopify.png" alt="Shopify Product" title="Shopify Product" className="w-5 h-5 object-contain shrink-0" />
      ) : (
        <img src="/woocomerce.png" alt="WooCommerce Product" title="WooCommerce Product" className="w-5 h-5 object-contain shrink-0" />
      )}
    </div>
  );
}
