            ...
            <div className="flex items-center justify-between px-4 h-11 border-b border-border bg-card sticky top-0 z-20 gap-4">
                ...
                <div className="flex items-center space-x-2">
                    <button 
                        ...
                        className="flex items-center space-x-1.5 px-3 py-1.5 bg-[#fe9900] text-black text-[11px] font-bold uppercase tracking-wider rounded hover:bg-[#F9E137] transition-all cursor-pointer"
                    >
                    ...
                    <table className="w-full border-separate border-spacing-0 text-left relative z-0">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {loading && notes.length === 0 ? (
                                ...
                                <tr><td colSpan={4} className="p-12 text-center text-slate-400">No notes found</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
